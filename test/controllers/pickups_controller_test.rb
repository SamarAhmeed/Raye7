...
class PickupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pickup" do
    assert_difference('Pickup.count') do
      post pickups_url, params: { pickup: { destination_id: @pickup.destination_id, source_id: @pickup.source_id, time: @pickup.time, user_id: @pickup.user_id } }
    end
  ...
  test "should update pickup" do
    patch pickup_url(@pickup), params: { pickup: { destination_id: @pickup.destination_id, source_id: @pickup.source_id, time: @pickup.time, user_id: @pickup.user_id } }
